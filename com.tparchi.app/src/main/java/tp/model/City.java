	...
	public boolean equals(Object obj){
		if(obj == null || !(obj instanceof City)){
			...
			if(((City) obj).getName().equals(this.name)
					&& ((City) obj).getCountry().equals(this.country)
					&& ((City) obj).getPosition().getLatitude()==this.getPosition().getLatitude()
					&& ((City) obj).getPosition().getLongitude()==this.getPosition().getLongitude()
					){
				return true;
